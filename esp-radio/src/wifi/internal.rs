...
unsafe extern "C" {
    pub unsafe fn __esp_radio_log_write(
        ...
        format: *const crate::sys::c_types::c_char,
        ...
    );
...
const WIFI_OSI_FUNCS: wifi_osi_funcs_t = wifi_osi_funcs_t {
    ...
    _random: Some(random),
    #[cfg(feature = "print-logs-from-driver")]
    _log_write: Some(__esp_radio_log_write),
    #[cfg(not(feature = "print-logs-from-driver"))]
    _log_write: None,
    #[cfg(feature = "print-logs-from-driver")]
    _log_writev: Some(__esp_radio_log_writev),
    #[cfg(not(feature = "print-logs-from-driver"))]
    _log_writev: None,
...
#[cfg(not(esp32s31))]
#[unsafe(no_mangle)]
pub(crate) static __ESP_RADIO_G_WIFI_OSI_FUNCS: wifi_osi_funcs_t = WIFI_OSI_FUNCS;

#[cfg(esp32s31)]
#[unsafe(no_mangle)]
pub(crate) static mut __ESP_RADIO_G_WIFI_OSI_FUNCS: wifi_osi_funcs_t = WIFI_OSI_FUNCS;
