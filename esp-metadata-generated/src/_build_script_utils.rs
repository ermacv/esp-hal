...
impl Chip {
        ...
        match self {
            Self::Esp32 => Config {
                ...
                symbols: &[
                    ...
                    "wifi_mac_version=\"1\"",
                    "wifi_csi_supported",
                    "ethernet_rx_store_and_forward",
                    "ethernet_dma_burst_len=\"32\"",
                    "phy_combo_module",
                    "rgb_display_output_lines=\"24\"",
                    "ledc_version=\"1\"",
                    ...
                    "soc_has_clock_node_i2s_mclk",
                    "soc_clock_node_i2s_mclk_is_configurable",
                    "has_dram_region",
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=ethernet_rx_store_and_forward",
                    "cargo:rustc-cfg=ethernet_dma_burst_len=\"32\"",
                    "cargo:rustc-cfg=phy_combo_module",
                    "cargo:rustc-cfg=rgb_display_output_lines=\"24\"",
                    ...
                    "cargo:rustc-cfg=soc_has_clock_node_pll_d2_clk",
                    ...
                    "cargo:rustc-cfg=soc_has_clock_node_i2s_mclk",
                    "cargo:rustc-cfg=soc_clock_node_i2s_mclk_is_configurable",
            ...
            Self::Esp32c3 => Config {
                ...
                symbols: &[
                    ...
                    "soc_has_clock_node_spi_function_clock",
                    "soc_clock_node_spi_function_clock_is_configurable",
                    "soc_has_clock_node_i2s_tx_clk",
                    "soc_clock_node_i2s_tx_clk_is_configurable",
                    "soc_has_clock_node_i2s_rx_clk",
                    "soc_clock_node_i2s_rx_clk_is_configurable",
                    "soc_has_clock_node_i2s_mclk_out",
                    "soc_clock_node_i2s_mclk_out_is_configurable",
                    "has_dram_region",
                    "has_dram2_uninit_region",
                    "has_irom_region",
                    "has_drom_region",
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_has_clock_node_spi_function_clock",
                    "cargo:rustc-cfg=soc_clock_node_spi_function_clock_is_configurable",
                    "cargo:rustc-cfg=soc_has_clock_node_i2s_tx_clk",
                    "cargo:rustc-cfg=soc_clock_node_i2s_tx_clk_is_configurable",
                    "cargo:rustc-cfg=soc_has_clock_node_i2s_rx_clk",
                    "cargo:rustc-cfg=soc_clock_node_i2s_rx_clk_is_configurable",
                    "cargo:rustc-cfg=soc_has_clock_node_i2s_mclk_out",
                    "cargo:rustc-cfg=soc_clock_node_i2s_mclk_out_is_configurable",
                    "cargo:rustc-cfg=has_dram_region",
                    "cargo:rustc-cfg=has_dram2_uninit_region",
                    "cargo:rustc-cfg=has_irom_region",
                    "cargo:rustc-cfg=has_drom_region",
            ...
            Self::Esp32c5 => Config {
                ...
                symbols: &[
                    ...
                    "soc_has_clock_node_crypto_pll_div",
                    "soc_has_clock_node_crypto_clk",
                    "soc_clock_node_crypto_clk_is_configurable",
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_has_clock_node_crypto_pll_div",
                    "cargo:rustc-cfg=soc_has_clock_node_crypto_clk",
                    "cargo:rustc-cfg=soc_clock_node_crypto_clk_is_configurable",
            ...
            Self::Esp32p4 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=ethernet_rx_checksum_offload",
                    "cargo:rustc-cfg=ethernet_dma_burst_len=\"32\"",
                    "cargo:rustc-cfg=soc_has_sdm_ch0",
                    "cargo:rustc-cfg=soc_has_sdm_ch1",
                    "cargo:rustc-cfg=soc_has_sdm_ch2",
            ...
            Self::Esp32s3 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=phy_backed_up_digital_register_count=\"21\"",
                    "cargo:rustc-cfg=phy_backed_up_digital_register_count_is_set",
                    "cargo:rustc-cfg=rgb_display_output_lines=\"16\"",
                    "cargo:rustc-cfg=ledc_version=\"2\"",
                    "cargo:rustc-cfg=ledc_channel_count=\"8\"",
                    "cargo:rustc-cfg=soc_has_sdm_ch0",
                    "cargo:rustc-cfg=soc_has_sdm_ch1",
            ...
            Self::Esp32s31 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=gpio_output_signal_max=\"256\"",
                    "cargo:rustc-cfg=dedicated_gpio_version=\"riscv_v2\"",
                    "cargo:rustc-cfg=lp_io_version=\"esp32s31\"",
                    "cargo:rustc-cfg=lp_io_has_gpio_matrix",
                    "cargo:rustc-cfg=uart_ram_size=\"128\"",
                    "cargo:rustc-cfg=uart_version=\"2\"",
                    "cargo:rustc-cfg=uart_peripheral_controls_mem_clk",
                    ...
                    "cargo:rustc-cfg=ethernet_mii_via_gpio_matrix",
                    "cargo:rustc-cfg=ethernet_rx_checksum_offload",
                    "cargo:rustc-cfg=ethernet_dma_burst_len=\"16\"",
                    "cargo:rustc-cfg=ethernet_has_rgmii",
                    "cargo:rustc-cfg=rgb_display_output_lines=\"24\"",
                    "cargo:rustc-cfg=soc_has_sdm_ch0",
                    "cargo:rustc-cfg=soc_has_sdm_ch1",
                    "cargo:rustc-cfg=soc_has_sdm_ch2",
    ...
    pub fn all_possible_symbols() -> &'static [&'static str] {
        &[
            ...
            "lp_io_version, \
             values(\"esp32\",\"v3\",\"v4\",\"esp32h2\",\"esp32p4\",\"v2\",\"esp32s31\")",
            ...
            "ethernet_dma_burst_len, values(\"32\",\"16\")",
            "rgb_display_output_lines, values(\"24\",\"16\")",
            ...
            "lcd_cam_dma_engine, values(\"AHB_GDMA\",\"AXI_GDMA\")",
        ]
    }
}
