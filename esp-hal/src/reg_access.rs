    ...
    impl<E: EndianessConverter> AlignmentHelper<E> {
        ...
        pub fn flush_to(&mut self, dst_ptr: *mut u32, offset: usize) -> usize {
            ...
            if self.buf_fill != 0 {
                ...
                // We return the **extra** bytes appended besides those already written into the
                // buffer.
            ...
            if self.buf_fill != 0 {
                ...
                for i in 0..max_fill {
                    match nbuf.get(i) {
                        ...
                        None => return (&[], false), /* Used up entire buffer before filling
                                                      * buff_fil */
                    }
                }
...
#[cfg(any(hmac_driver_supported, sha_driver_supported))]
pub(crate) use alignment_helper::*;
